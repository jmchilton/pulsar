...
def test_coexecution_job_name_is_stable_across_client_instances():
    ...
    params = {"galaxy_instance_id": "inst"}
    for client_class in COEXECUTION_CLIENT_CLASSES:
        first = _coexecution_client_stub(client_class, params, instance_id="inst")
        second = _coexecution_client_stub(client_class, params, instance_id="inst")
...
def test_coexecution_job_name_is_shared_across_backends():
    params = {"galaxy_instance_id": "inst"}
    names = {
        client_class.__name__: _coexecution_client_stub(client_class, params, instance_id="inst")._job_name
        for client_class in COEXECUTION_CLIENT_CLASSES
    }
...
def test_coexecution_job_id_prefix_is_configurable():
    params = {"job_id_prefix": "mysite", "galaxy_instance_id": "inst"}
    for client_class in COEXECUTION_CLIENT_CLASSES:
